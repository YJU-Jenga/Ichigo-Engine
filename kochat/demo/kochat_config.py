...
root_dir = '/home/emchang/Documents/GitHub/Ichigo-Engine/kochat/demo'
...
PROC = {
    ...
    'visualization_epoch': 5,  # 시각화 빈도 (애폭마다 시각화 수행)
...
ENTITY = {
    ...
    'epochs': 1000,  # 엔티티 학습 횟수 - 기본값 1000
